...
// Route::get('/recommendations', 'RecommenderController@recommendProducts');

// khalti CartController
use App\Http\Controllers\KhaltiPaymentController;

Route::get('/payment', [KhaltiPaymentController::class, 'initiatePayment'])->name('payment.initiate');
Route::post('/payment/verify', [KhaltiPaymentController::class, 'verifyPayment'])->name('payment.verify');
