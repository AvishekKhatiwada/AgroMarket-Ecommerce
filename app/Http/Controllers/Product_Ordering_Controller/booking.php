        ...
        public function  order_proceed(Request $request)
        {
            ...
            /*Order Details Ends Here*/
                 ...
                 else
                 {
    	                ...
    	                <p>Thank you for your order. We’ll send a confirmation when your order ships. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="https://www.agromarket.com">agromarket.com</a></p>
    	               ...
    	               '.$Delivery_Address.'</p>
    	                ...
    	                $emailcontent=array(
    	                    ...
    	                    ($loginid, $name,$id)
    	                    {
    	                        ...
    	                        ('Your agromarket.com order '.$id.' is Confirmed');
