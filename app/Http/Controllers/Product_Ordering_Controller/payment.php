        	               ...
        	               '.$Delivery_Address.'</p>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    ($loginid, $name,$O_id)
        	                    {
        	                        ...
        	                        ('Your AgroMarket.com Order Payment '.$O_id.' is Successfully Paid');
                    ...
                    */
                    $Transaction->save();
                      ...
                      $welcomemessage='Hello '.$name.'';
        	                ...
        	                <a href="https://www.AgroMarket.com/proceed_to_Payment/'.$O_id.'">https://www.AgroMarket.com/proceed_to_Payment/'.$O_id.'</a></p>
        	                <h4>Order Details: </h4><p> Order No:'.$O_id.$Order_Details.'</p>
        	                 <p><strong>Delivery Address:</strong>
        	               '.$Delivery_Address.'</p>
        	                <p> <strong>Total Amount:</strong>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    {
        	                        $message->to($loginid, $name)->subject
        	                        ('Your AgroMarket Order '.$O_id.' Payment is Failed');
        	                        $message->from('codetalentum@btao.in','AgroMarket');
