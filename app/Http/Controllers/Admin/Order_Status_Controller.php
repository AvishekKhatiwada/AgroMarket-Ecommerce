        ...
        /* Email Alert Starts Here*/
         ...
         $Order_Details=$Orders->Order_Details;
            ...
            $status=$Orders->p_status;
        	                ...
        	                $emailbody='<p>Your Order has been Shipped. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="https://www.AgroMarket.com">AgroMarket.com</a></p><br>
        	               ...
        	               '.$Delivery_Address.'</p>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    ($loginid, $name,$id)
        	                    {
        	                        ...
        	                        (' Your AgroMarket.com order '.$id.' is Shipped');
        	                        $message->from('codetalentum@btao.in','AgroMarket');
         ...
         $Order_Details=$Orders->Order_Details;
            ...
            $status=$Orders->p_status;
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    {
        	                        $message->to($loginid, $name)->subject
        	                        ('Your AgroMarket.com order '.$id.' is Delivered');
        	                        $message->from('codetalentum@btao.in','AgroMarket');
            ...
            $status=$Orders->p_status;
        	               ...
        	               '.$Delivery_Address.'</p>
        	                ...
        	                $emailcontent=array(
        	                    ...
        	                    {
        	                        $message->to($loginid, $name)->subject
        	                        ('Your AgroMarket.com order '.$id.' is Cancelled');
        	                        $message->from('codetalentum@btao.in','AgroMarket');
