@extends('layout')
@section('title') Agro Market @endsection
    ...
    <br>
      <div class="row ">
        ...
        <div  align="center" class="col-md-8 wow animated flash slow">
            <h1 class="black-text" style="font-weight:bold;">Agro Market Features</h1>
            ...
            <div class="row my-5" style="font-size:30px; font-family: 'Balsamiq Sans', cursive;">
              <div class="col-md-6" >
                    <ul align="left" style="list-style:none;">
                        <li><i class="fab fa-pagelines"></i> Fresh vegetables</li><br>
                        <li><i class="fab fa-pagelines"></i> Eco Friendly Products</li>
                    </ul>
              </div>
              <div class="col-md-6">
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-pagelines"></i> Delivery to your doorstep</li><br>
                    <li><i class="fab fa-pagelines"></i> Quality Vegetable </li>
                  </ul>
              </div>
            </div>
...
@php
$Products=App\Models\Products::where('status','=','1')->limit(8)->get();
@endphp
...
<section id="Products" align="center" class="px-5 wow animated fadeInUpBig fast" style=" font-family: 'Balsamiq Sans', cursive;">
    ...
    <p  align="center" class="mx-5" style="margin-top:-30px; font-family: 'Balsamiq Sans', cursive;">
              <a href="{{url('product')}}"  target="_blank" class="btn btn-dark">More Products</a>
              </p>
              ...
              <div class="col-lg-5 d-flex align-items-stretch">
                <div align="left" class="info">
                  ...
                  <i class="fas fa-map-marker-alt"></i>
                    <h4>Location:</h4>
                    <p>  Kakarvitta -515004</p>
                  </div>

                  <div class="email">
                  <i class="fas fa-envelope"></i>
                    <h4>Email:</h4>
                    <p>agromarket@gmail.com</p>
                  </div>

                  <div class="phone">
                  <i class="fas fa-phone"></i>
                    <h4>Call:</h4>
                    <p>YUbraj : +977 9800000000<br>
Sushant : +977 9812345678</p>
                  </div>

                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7131.5775387272015!2d88.11744328829124!3d26.655244795841796!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e5b3a58c62771d%3A0x960ba2df9c13c28a!2sItabhatta%20Chowk%2C%20Mechinagar%2057200!5e0!3m2!1sen!2snp!4v1690959773199!5m2!1sen!2snp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
...
<p align="center" class="py-2"><br>
   <button class="btn btn-dark" data-toggle="modal" data-target="#modalSocial" >Subscribe to Agro Market</button>
   </p>
  ...
  <div class="modal-dialog cascading-modal" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header  darken-3 white-text" style="background-color:#40BFD6;">
        <h4 class="title"><i class="fas fa-users"></i> Subscribe to Our AgroMarket</h4>
