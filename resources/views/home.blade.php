    ...
    <br><br>
      <div class="row">
        ...
        <div  align="center" class="col-md-8">
            <h1 class="black-text" style="font-weight:bold;">About AgroMarket</h1>
            <div class="col-md-3" style=" border-bottom: 2px solid #003399;"></div>
            <div class="row my-5" style="font-size:30px;">
              <div class="col-md-6" >
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-pagelines"></i> Fresh vegetables</li>
                    <li><i class="fab fa-pagelines"></i> Delivery to your doorstep</li>
                    </ul>
              </div>
              <div class="col-md-6">
                    <ul align="left" style="list-style:none;">
